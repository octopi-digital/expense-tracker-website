  ...
  return (
    <div
      className="
        ...
        [&_a]:font-semibold [&_a]:text-emerald-brand [&_a]:underline [&_a]:decoration-emerald-brand/30 [&_a]:underline-offset-4 hover:[&_a]:decoration-emerald-brand
        ...
        [&_td]:border-b [&_td]:border-divider [&_td]:py-3 [&_td]:pr-4 [&_td]:align-top
        [&_th]:border-b [&_th]:border-divider [&_th]:py-3 [&_th]:pr-4 [&_th]:text-left [&_th]:font-bold [&_th]:text-ink
...
export function LegalNote({ children }: { children: ReactNode }) {
  return (
    <div className="mt-8 rounded-2xl border-l-4 border-gold bg-[rgba(215,162,37,0.07)] px-6 py-5">
